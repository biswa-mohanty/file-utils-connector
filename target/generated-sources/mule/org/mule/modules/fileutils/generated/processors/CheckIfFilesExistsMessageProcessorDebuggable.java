...
public class CheckIfFilesExistsMessageProcessorDebuggable
    extends CheckIfFilesExistsMessageProcessor
    implements DebugInfoProvider
{


    public CheckIfFilesExistsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("directoryPath", "Directory path", (java.lang.String.class), directoryPath, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("pattern", "Pattern", (java.lang.String.class), pattern, muleEvent));
