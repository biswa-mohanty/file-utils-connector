...
public class CopyFilesDirectlyMessageProcessorDebuggable
    extends CopyFilesDirectlyMessageProcessor
    implements DebugInfoProvider
{


    public CopyFilesDirectlyMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("sourceDirectoryPath", "Source directory path", (java.lang.String.class), sourceDirectoryPath, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("targetDirectoryPath", "Target directory path", (java.lang.String.class), targetDirectoryPath, muleEvent));
